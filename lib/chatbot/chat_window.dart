...
import 'package:mhs_pred_app/chatbot/models/message_model.dart';
                                      ...
                                      child: TextField(
                                       ...
                                       keyboardType: TextInputType.multiline,
                                        ...
                                        decoration:
                                          ...
                                          hintText: 'Enter paragraph from which code snippets need to extracted...',
                                        ),
                                      ),
                                    ),
                                  )),),
            ...
            Stack(
              children: <Widget>[
                Row(
                  ...
                  child: const Text('Extract code snippets', style: TextStyle(fontSize: 16)),
                  onPressed: () {
                    String value="extracting code snippets...";
